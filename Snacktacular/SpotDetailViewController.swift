...
class SpotDetailViewController: UIViewController {
    ...
    let regionDistance: CLLocationDistance = 750// 750m = 0.5mile
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            ...
            case "AddReview" :
                ...
                let destination = navigationController.viewControllers.first as! ReivewTableViewController
                destination.spot = spot
                if let selectedIndexPath = tableView.indexPathForSelectedRow {
                    tableView.deselectRow(at: selectedIndexPath, animated: true)
                }
            case "ShowReview" :
                let destination = segue.destination as! ReivewTableViewController
                destination.spot = spot
    ...
    @IBAction func lookpPlacePressed(_ sender: UIBarButtonItem) {
...
extension SpotDetailViewController: CLLocationManagerDelegate{
        ...
        func handleLocationAuthorizationStatus(status: CLAuthorizationStatus){
            ...
            case .denied:
                showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select 'Settings' below to open devices settings and enable location services for this app.")
            case .restricted:
